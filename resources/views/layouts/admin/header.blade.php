    ...
    <div class="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <form action="{{ route('auth.destroy', auth()->user()->id ?? 1) }}" method="POST"
                ...
                @csrf
                @method('DELETE')
                <button type="submit" class="nav-link btn btn-link p-0" style="text-decoration:none; color:inherit;">
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img src="{{ asset('assets/assets-admin/images/faces/face4.jpg') }}" alt="image"
                                class="profile-pic">
                        </div>
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img src="{{ asset('assets/assets-admin/images/faces/face2.jpg') }}" alt="image"
                                class="profile-pic">
                        </div>
                        <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img src="{{ asset('assets/assets-admin/images/faces/face3.jpg') }}" alt="image"
                                class="profile-pic">
                        </div>
                        <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
